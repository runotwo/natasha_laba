    ...
    render: function () {
        ...
        return (
            <div className={rowClass}>
                <div className="col-4 cell">{this.props.title}</div>
                <div className="col-2 cell">{this.props.count}</div>
...
function List(props) {
    ...
    const listItems = vouchers.map((voucher) =>
        <Voucher title={voucher.good__name}
                 count={voucher.sum_count}
                 sum_price={voucher.sum_price}
                 sum_val={voucher.sum_val}
                 />
    );
    return (
        <div>{listItems}</div>
